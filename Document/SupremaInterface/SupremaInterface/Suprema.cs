...
namespace SupremaInterface
{
    public class Suprema
    {
        ...
        receivePacket()
        {
            ...
            result = supremaEngine.UF_ReceivePacket(packet, 50);
        ...
        public UF_RET_CODE getNumOfLog(ref uint numOfLog, 
                                        ref uint numOfTotalLog)
        {
            UF_RET_CODE result;


            result = supremaEngine.UF_GetNumOfLog(ref numOfLog, ref numOfTotalLog);
        ...
        public UF_RET_CODE readLog(int startIndex, int count, UFLogRecord[] logRecord, ref int readCount)
        {
            UF_RET_CODE result;

            result = supremaEngine.UF_ReadLog(startIndex, count, logRecord, ref readCount);
